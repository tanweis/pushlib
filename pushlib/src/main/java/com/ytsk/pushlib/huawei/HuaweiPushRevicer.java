...
//        if (context==null||tokenIn==null)return;
//    	String belongId = extras.getString("belongId");
//        Log.d(TAG,"huawei token:"+tokenIn);
//        PushUtil.sendBroadcast(context,tokenIn);
////        RxBus.getDefault().post(tokenIn);
////        LoginConstants.setPushToken(tokenIn);
////        RxBusReplaySubject.getDefault().post(tokenIn);
...
//            TanMsg msgs=TanMsg.newMsg()
//                    .type(TanMsg.PUSH_TYPE_PASSTHROUGHT)
//                    .custom(content);
//            PushUtil.sendBroadcast(context,msgs);
////            Timber.i("huawei push msg:"+content);
//////            if (bundle==null)
//////                return false;
//////            byte [] pushCus=bundle.getByteArray(BOUND_KEY.pushMsgKey);
//////            if (pushCus==null)
//////                return false;
//////            String cus = new String(pushCus, "UTF-8");
////            Notification2.PushMsg notification=parseNotice(content);
////
////            if (notification == null)
////                return false;
////            String thisPhone = LoginConstants.getPhone();
////            if (!LoginConstants.isLogin() || thisPhone == null) {
////                ToastUtils.showShort("接货宝未登录");
////                return false;
////            }
////            if (!thisPhone.equals(notification.driverTel)) {
////                ToastUtils.showShort("此派车单不属于你");
////                return false;
////            }
////            if (notification.waybillId == null)
////                return false;
////            if (notification.isTempCtrl()) {
////                RxBus.getDefault().post(Mconstants.PLAY_SOUND_TEMPERATURE);
////            } else if (notification.status != null && notification.status == WaybillStatus.CONFIRM.getStatus())
////                RxBus.getDefault().post(Mconstants.PLAY_SOUND_STATUS);
//
//            Intent intent = new Intent();
//            intent.setAction(ACTION_UPDATEUI);
...
////            Timber.i("huawei push msg ex:"+e.getMessage());
//            callBack(intent);
//        }
//        return false;
//    }
